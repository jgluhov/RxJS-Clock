...
function drawHands(): void {
    ...
    drawHand(hour, Math.PI * 2 / 12, RADIUS - HAND_TRUNCATION - HOUR_HAND_TRUNCATION);
    drawHand(date.getMinutes(), Math.PI * 2 / 60, RADIUS - HAND_TRUNCATION);
    drawHand(date.getSeconds(), Math.PI * 2 / 60, RADIUS - HAND_TRUNCATION);
}
